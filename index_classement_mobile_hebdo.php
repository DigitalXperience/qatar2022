...
if ($result = $mysqli->query("
	...
	WHERE 
		...
		and  pr.dateheure > '2022-11-18 00:01:00' 
		and pr.dateheure < '2022-11-26 20:00:00'
	GROUP BY 
		u.`id` 
	ORDER BY 
		pts DESC, 
...
$sql = "SELECT pr.`utilisateur_id`, pr.`score_eq1`, pr.`score_eq2`, pr.`vainqueur_id`, pr.`dateheure`, SUM(pr.`pts_obtenus`) AS pts 
			...
			AND pr.`utilisateur_id` = $id and  pr.dateheure > '2022-11-18 00:01:00' and pr.dateheure < '2022-11-26 20:00:00' 
...
// S'il n'a encore rien pronostiqué
...
<li><a href="#" class="active">Hebdo</a></li>
<li><a href="https://<?php echo $_SERVER['SERVER_NAME']; ?>/qatar2022/index_classement_mobile.php?list=all&idcompetition=<?php echo $idcompetitions; ?>" class="">Général</a></li>
</ul>

<div class="success">
	Classement en fonction du nombre de points obtenus du <b>20 Novembre</b> au <b>26 Novembre</b> 
</div>
...
<div class="userRankInfo">
	...
	?> 
		...
		<h3 class="betTitle">Classement Hebdo</h3>
		<ul class="rankList">
			<?php 
			$d = 1;
